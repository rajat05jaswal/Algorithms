...
public class UF_HWQUPC implements UF {
    ...
    public int find(int p) {
        ...
        while (root != parent[root]) {
            if (pathCompression) doPathCompression(root,parent);
            root = parent[root];
        }
        return root;
        // ... end of TODO
    ...
    public String toString() {
        ...
        stringBuilder.append("\n  path compression? ").append(pathCompression).append(";");
        stringBuilder.append("\n  parents: ").append(Arrays.toString(parent)).append(";");
        stringBuilder.append("\n  heights: ").append(Arrays.toString(height)).append(".");
